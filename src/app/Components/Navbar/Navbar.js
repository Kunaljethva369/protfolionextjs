        ...
        <>
            <nav className='md:py-6 py-3'>
                <ul className={menu ? 'active' : ''}>
                    <li><Link href={'/'} onClick={() => { setMenu(false) }} passHref>Home</Link></li>
                    <li><Link href={'/about'} onClick={() => { setMenu(false) }} passHref>About</Link></li>
                    <li><Link href={'/project'} onClick={() => { setMenu(false) }} passHref>Projects</Link></li>
                    <li><Link href={'/contact'} onClick={() => { setMenu(false) }} passHref>Contact</Link></li>
                </ul>
