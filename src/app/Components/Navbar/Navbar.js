        ...
        <>
            <nav className='md:py-6 py-3'>
                <ul className={menu ? 'active' : ''}>
                    ...
                    <li ><Link href='/' onClick={() => { setMenu(false) }}>Home</Link></li>
                    <li><Link href='/about' onClick={() => { setMenu(false) }}>About</Link></li>
                    <li><Link href='/project' onClick={() => { setMenu(false) }}>Projects</Link></li>
                    <li><Link href='/contact' onClick={() => { setMenu(false) }}>Contact</Link></li>
                </ul>
