        ...
        <>
            <nav className='md:py-6 py-3'>
                <ul className={menu ? 'active' : ''}>
                    <li className={router == "/" ? "activemenu px-5" : "px-5"}><Link href={'/'} onClick={() => { setMenu(false) }} passHref>Home</Link></li>
                    <li className={router == "/about" ? "activemenu px-5" : "px-5"}><Link href={'/about'} onClick={() => { setMenu(false) }} passHref>About</Link></li>
                    <li className={router == "/project" ? "activemenu px-5" : "px-5"}><Link href={'/project'} onClick={() => { setMenu(false) }} passHref>Projects</Link></li>
                    <li className={router == "/contact" ? "activemenu px-5" : "px-5"}><Link href={'/contact'} onClick={() => { setMenu(false) }} passHref>Contact</Link></li>
                </ul>
